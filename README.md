<h1> Flare.css</h1>
Flare is a modern CSS library that allows you to create responsive layouts with less code. Flare also gives you faster and better ways to create layouts by using flexbox to its full potential.
